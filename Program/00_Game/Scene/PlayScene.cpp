...
STATUS map[DIV][DIV] = {
	{STATUS::GOAL, STATUS::EMPTY, STATUS::EMPTY, STATUS::EMPTY, STATUS::EMPTY},
	{STATUS::EMPTY, STATUS::EMPTY, STATUS::EMPTY, STATUS::START, STATUS::EMPTY},
...
//			tkl::Algorithm::RouteSearch(DIV, DIV, mFields, mRoute);
	...
	// TODO：最短経路表示用
	for(int i = 0; i < mRouteMesh.size(); ++i){
		mRouteMesh[i]->Draw(mCamera);
	}
