...
public:
	...
	void SetRenderer(std::shared_ptr<tkl::Renderer> renderer){ mRenderer = renderer; }
	std::shared_ptr<tkl::Renderer> GetRenderer() const { return mRenderer; }
...
private:
	...
	std::shared_ptr<tkl::Renderer> mRenderer;
